function chooseAdventure(choice) {
    ...
    } else if (choice == 1 && button1 == "Walk with him") {
    ...
    } else if (choice == 2 && button2 == "Walk alone") {
    ...
    } else if (choice == 1 && button1 == "Go investigate") {
    ...
    } else if (choice == 2 && button2 == "Wait for the rustling to go away") {
    ...
    else if (choice == 1 && button1 == "Accept his offering") {
    ...
    } else if (choice == 2 && button2 == "No quit") {
